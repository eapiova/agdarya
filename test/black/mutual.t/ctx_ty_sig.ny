...
ctx_ty_type : Set
ctx_ty_type = sig ( ctx : Set, ty : ctx → Set )
...
ctx_ty_tm = (
  ...
  | sub (A : ctx_ty_tm ty Γ) (B : ctx_ty_tm ty (ext Γ A))
      (a : ctx_ty_tm tm Γ A) ],
  ...
  | lam (A : ctx_ty_tm ty Γ) (B : ctx_ty_tm ty (ext Γ A))
      (b : ctx_ty_tm tm (ext Γ A) B)
    : ctx_ty_tm tm Γ (pi A B)
  | app (A : ctx_ty_tm ty Γ) (B : ctx_ty_tm ty (ext Γ A))
      (f : ctx_ty_tm tm Γ (pi A B)) (a : ctx_ty_tm tm Γ A)
    : ctx_ty_tm tm Γ (sub A B a) ])
